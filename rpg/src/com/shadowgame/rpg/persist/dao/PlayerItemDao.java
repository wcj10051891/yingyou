...
public interface PlayerItemDao {
	@Sql(value="insert into player_item(	`id`,	`itemId`,	`playerId`,	`binding`,	`num`,	`strengthenLv`,	`hole`,	`createTime`	) values(	:playerItem.id,	:playerItem.itemId,	:playerItem.playerId,	:playerItem.binding,	:playerItem.num,	:playerItem.strengthenLv,	:playerItem.hole,	:playerItem.createTime	)")
	...
	@Sql(value="update player_item set 	`id`=:playerItem.id,	`itemId`=:playerItem.itemId,	`playerId`=:playerItem.playerId,	`binding`=:playerItem.binding,	`num`=:playerItem.num,	`strengthenLv`=:playerItem.strengthenLv,	`hole`=:playerItem.hole,	`createTime`=:playerItem.createTime	 where id=:playerItem.id")
